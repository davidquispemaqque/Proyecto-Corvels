...
const specialists = [
  ...
  {
    "id": 6,
    "name": "Eliz Yuliana Rojas",
    "role": "Seguridad y Salud en el Trabajo",
    "image": "eliz.jpg",
    "bio": "Mi nombre es Eliz Yuliana Rojas Gutierrez, especialista en el desarrollo de documentos de Seguridad y Salud en el Trabajo (SST). Actualmente, me desempeño en el desarrollo de documentos de seguridad y salud ocupacional para pequeñas y medianas empresas. Mis responsabilidades incluyen la elaboración de Procedimientos de Trabajo Seguro (PTS), mapas de procesos, Checklist y mapas de áreas identificadas (LAYOUT) utilizando AutoCAD.",
